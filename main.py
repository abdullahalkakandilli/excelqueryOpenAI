...
def get_values(question_input):
    try:
        output = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system",
                 "content": "Answer the question truthfully based on the given dataframe below. Write short answer by using bullet points. Most important thing is finding/calculating the answer and then find other details about the given question. Don't care data quality issues like missing values. Question: " + question_input},
